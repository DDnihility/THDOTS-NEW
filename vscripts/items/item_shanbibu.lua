...
function modifier_item_shanbibu_passive:IsPurgable() return false end
function modifier_item_shanbibu_passive:IsPurgeException() return false end
function modifier_item_shanbibu_passive:RemoveOnDeath() return false end
function modifier_item_shanbibu_passive:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end
