...
function modifier_thdots_youmu04_states:OnCreated()
  ...
  self:StartIntervalThink(0.1)
	...
	THDReduceCooldown(self.ability,FindTelentValue(caster,"special_bonus_unique_youmu_3"))
...
function OnYoumu04SpellStart(keys)
	...
	THDReduceCooldown(keys.ability,FindTelentValue(caster,"special_bonus_unique_youmu_3"))
...
function AbilityYoumu:OnYoumu01Start(keys)
	local caster = EntIndexToHScript(keys.caster_entindex)
	THDReduceCooldown(keys.ability,FindTelentValue(caster,"special_bonus_unique_youmu_4"))
