...
function ability_thdots_nitori03:GetIntrinsicModifierName()
	return "modifier_ability_thdots_nitori03"
end
...
function modifier_ability_thdots_nitori03:IsHidden() 		return false end
