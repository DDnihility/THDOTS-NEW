...
function Meirin03passive(keys)
	...
	local damageblock = keys.DamageBlock+FindTelentValue(caster,"special_bonus_unique_meirin_2") -- 格挡伤害
...
function Meirin03Damage( keys )
	...
	for _,v in pairs (targets) do
		local damage = keys.damage + FindTelentValue(caster, "special_bonus_unique_meirin_3")
		if v:IsCreep() then
